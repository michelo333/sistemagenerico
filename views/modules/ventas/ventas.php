...
<!-- segunda mitad de la tabla de ventas -->
        ...
        <h2 class="alert alert-danger text-lg-center text-danger">Detalles</h2>
          ...
          <br>
          <td align="center">
              <?php echo '<span class="text-primary">Igv </span> ' . '<span class="right"> $' . $igv . '</span>'; ?>
          </td>
          <br>
          <td align="center">
...
<!-- script para pasar los datos de los productos al formulario de venta. -->
<script>
